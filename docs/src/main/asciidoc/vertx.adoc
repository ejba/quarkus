...
quarkus.http.forwarded-host-header=X_FORWARDED_HOST <2>
----

<1> This sets the replacement of the internal host to the host delivered by the request header specified in <2>
<2> This defines the request header quarkus shall replace its internal host with. Default is X_FORWARDED_HOST.
